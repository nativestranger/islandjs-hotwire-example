...
function Reactions(_ref) {
  ...
  var toggleReaction = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(emoji) {
      var _document$querySelect, csrfToken, userReaction, response, _response, data, errorData, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            setLoading(true);
            _context.p = 2;
            csrfToken = (_document$querySelect = document.querySelector('meta[name="csrf-token"]')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getAttribute('content'); // Check if current user has already reacted with this emoji
            userReaction = reactions.find(function (r) {
              return r.emoji === emoji && r.session_id === currentSessionId;
            });
            if (!userReaction) {
              _context.n = 4;
              break;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  }, "Add")), showPicker && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      ...
      disabled: loading,
      className: "\n            inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm rounded-full transition-all duration-200\n            ".concat(data.userHasReacted ? 'bg-gradient-to-r from-indigo-100 to-purple-100 border-2 border-indigo-400 hover:from-indigo-200 hover:to-purple-200' : 'bg-gradient-to-r from-slate-50 to-slate-100 border border-slate-200 hover:from-slate-100 hover:to-slate-200 hover:border-slate-300', "\n            ").concat(loading ? 'opacity-50 cursor-not-allowed' : 'hover:scale-110 hover:shadow-md active:scale-100 cursor-pointer', "\n          "),
      ...
      className: "font-semibold ".concat(data.userHasReacted ? 'text-indigo-700' : 'text-slate-700')
    }, data.count));
  }));
}
...
/******/ })()
;
//# sourceMappingURL=islands_bundle.817d971877ad4e7c9124.js.map